...
const creative_approvals_routes_1 = require("./modules/creatives/creative-approvals.routes");
...
const screenGroups_routes_1 = require("./modules/screen-groups/screenGroups.routes");
...
app.use("/api/creative-approvals", creative_approvals_routes_1.creativeApprovalsRouter);
...
app.use("/api/screen-groups", screenGroups_routes_1.screenGroupsRouter);
